...
$_ADMINLANG['addons']['areyousuredelete'] = "Weet u zeker dat u deze add-on wilt verwijderen?";
...
$_ADMINLANG['general']['kbseourls'] = "SEO vriendelijke URLs";
$_ADMINLANG['general']['kbseourlsinfo'] = "Schakel in om SEO vriendelijke URLs te gebruiken (u dient het bestand: htaccess.txt op uw server te hernoemen naar .htaccess).";
...
$_ADMINLANG['general']['disableautocreditapply'] = "Krediet toepassen";
